...
classifier = cv2.CascadeClassifier('C:/Users/madhu/OneDrive/Desktop/face detection/face detection/haarcascade_frontalface_default.xml')

model = load_model("C:/Users/madhu/OneDrive/Desktop/face detection/face detection/final_model.h5")

URL = 'http://192.0.0.4:8080/shot.jpg'

def get_pred_label(pred):
    labels = ["madhusmita sahu"]
    return labels[pred]
